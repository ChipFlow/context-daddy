...
async def list_tools() -> list[Tool]:
    ...
    return [
        ...
        Tool(
            ...
            description="Get the source code content of a symbol by exact name. FASTER than Grep/Search+Read - directly retrieves function/class/method source code from pre-indexed line ranges. Use this instead of Grep when you know the symbol name.",
            inputSchema={
                "type": "object",
                "properties": {
                    "name": {
